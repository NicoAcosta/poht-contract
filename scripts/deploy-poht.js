...
async function main() {
	...
	const PoHVerifierV2 = await hre.ethers.getContractFactory('PoHVerifierV2')
	const contract = await PoHVerifierV2
		.deploy
		// _poHAddress,
		// _linkAddress,
		// _oracleAddress,
	...
	console.log('PoHVerifierV2 deployed to: ', contract.address)
}
